...
pub struct StellarError {
    ...
    #[serde(rename = "type")] problem_type: String,
    title: String,
    status: u16,
    detail: String,
    instance: String,
...
impl StellarError {
    ...
    pub fn is_before_history(&self) -> bool {
       self.problem_type == "before_history"
    }
    ...
    pub fn is_not_acceptable(&self) -> bool {
       self.problem_type == "not_acceptable"
    }
    ...
    pub fn is_not_implemented(&self) -> bool {
       self.problem_type == "not_implemented"
    }
    ...
    pub fn is_rate_limit_exceeded(&self) -> bool {
       self.problem_type == "rate_limit_exceeded"
    }
    ...
    pub fn is_internal_server_error(&self) -> bool {
       self.problem_type == "internal_server_error"
    }
    ...
    pub fn is_stale_history(&self) -> bool {
       self.problem_type == "stale_history"
    }
    ...
    pub fn is_transaction_failed(&self) -> bool {
       self.problem_type == "transaction_failed"
    }
    ...
    pub fn is_transaction_malformed(&self) -> bool {
       self.problem_type == "transaction_malformed"
    }
}
...
mod asset_identifier_tests {
    ...
    fn it_parses_native_assets_from_json() {
        ...
        assert_eq!(println!("{}", before_history), "This horizon instance is configured to only track a portion of the stellar network's latest history. This request is asking for results prior to the recorded history known to this horizon instance.");
        assert!(native_asset.is_before_history());
        assert!(!native_asset.is_before_history());
    }
