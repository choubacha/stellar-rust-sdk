...
/// ransactions are the basic unit of change in the Stellar Network.
...
mod transaction_tests {
    ...
    fn it_parses_into_a_transaction() {
        ...
        assert_eq!(transaction.id(), "648da0d47aa3b3b20afd4499a68f89b6d10ead8b1f38858e99b1d94b6fef6e69");
        assert_eq!(transaction.paging_token(), "71946212651044864");
        assert_eq!(transaction.hash(), "648da0d47aa3b3b20afd4499a68f89b6d10ead8b1f38858e99b1d94b6fef6e69");
        assert_eq!(transaction.ledger(), 16751283);
        assert_eq!(transaction.created_at(), Utc.ymd(2018, 3, 10).and_hms(23, 16, 42));
        assert_eq!(transaction.source_account(), "GB6YPGW5JFMMP2QB2USQ33EUWTXVL4ZT5ITUNCY3YKVWOJPP57CANOF3");
        ...
        assert_eq!(transaction.envelope_xdr(), "");
        assert_eq!(transaction.result_xdr(), "AAAAAAAAAGQAAAAAAAAAAQAAAAAAAAABAAAAAAAAAAA=");
        assert_eq!(transaction.result_meta_xdr(), "");
        assert_eq!(transaction.fee_meta_xdr(), "")
    }
}
